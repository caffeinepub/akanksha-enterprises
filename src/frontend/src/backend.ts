...
export class Backend implements backendInterface {
    ...
    async addOwner(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOwner();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async isOwner(arg0: Principal): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isOwner(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitMessage(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<bigint> {
        if (this.processError) {
            try {
